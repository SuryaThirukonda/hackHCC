...
export function buildCompactReplayGraph(recording) {
  ...
  const compactSamples = samples
    ...
    .map((sample) => ({
      ...
      jitter_event: sample.jitter_grouped_event ?? sample.jitter_event ?? false,
      jitter_grouped_event: sample.jitter_grouped_event ?? sample.jitter_event ?? false,
      jitter_reason: sample.jitter_reason ?? null,
      trend_residual: sample.trend_residual ?? null,
      jitter_debug: sample.jitter_debug ?? null,
