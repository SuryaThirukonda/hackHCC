...
def elbow_angle(shoulder: Point | None, elbow: Point | None, wrist: Point | None) -> float:
    return calculate_angle(shoulder, elbow, wrist)


def shoulder_raise_angle(hip: Point | None, shoulder: Point | None, wrist: Point | None) -> float:
